...
import { getLectureBySlug, getLectureSlugs } from "@/lib/sanity/api";
...
export async function generateMetadata({
  ...
  const item = await getLectureBySlug(params.slug);
  ...
  return {
    ...
    alternates: languageAlternates(lang, `/lectures/${params.slug}`),
    openGraph: {
      url: `https://52hzsoundcabinet.com/${params.lang}/lectures/${params.slug}`
    }
  };
}
