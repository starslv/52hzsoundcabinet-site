...
export const expeditionType = defineType({
  ...
  fields: [
    ...
    defineField({ name: "gearList", title: "Gear List", type: "array", of: [defineArrayMember({ type: "string" })] }),
    defineField({ name: "audioThemes", title: "Audio Themes", type: "array", of: [defineArrayMember({ type: "string" })] }),
    defineField({
      name: "relatedOutputs",
      ...
      of: [
        defineArrayMember({
          type: "reference",
          to: [{ type: "project" }, { type: "researchPost" }]
        })
      ]
    })
  ]
